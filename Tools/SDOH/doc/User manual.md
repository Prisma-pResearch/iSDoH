...
## Step 3: Exposome Linkage Process

### Getting Started

[Demo](https://www.loom.com/share/bc4097b0d3db4f8f9132a06a49c17e71?sid=ad9671c1-6535-4bc9-b893-7e917efbcf75)

1. **Sign Up**: Begin by navigating to the [registration page](https://exposome.rc.ufl.edu/)(#) to create an account. Follow the on-screen instructions to complete the sign-up process.
...
- **Processing**: After uploading your CSV file, our system will automatically execute the necessary Python script in the backend to perform Exposome linkage.
